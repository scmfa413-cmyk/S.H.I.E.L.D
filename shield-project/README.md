...
Expected workflow:
1. Research Agent searches for recent AI developments
2. Analysis Agent compares and analyzes findings
3. Report is generated and saved
...
Expected workflow:
1. Code Agent understands requirements
2. Generates project structure
3. Creates implementation
4. Validates syntax
5. Returns ready-to-run code
...
Expected workflow:
1. File Tool reads PDF
2. Analysis Agent processes content
